...
<div class="columns">
  <div class="column is-8 is-offset-2">
    <section class="section">
      <h1 class="title">Serviços Prestados</h1>
      <div class="content">
        <p>Os nossos serviços são focados na pequena e média empresa. Nosso alvo é atender as demandas deste nicho, que possui características próprias. Estas empresas requerem uma atenção especial da contabilidade porque não possuem departamentos específicos
          e contam com nossos serviços e orientações. Com um serviço diferenciado, especializamos nas seguintes áreas:</p>

        <ul>
          <li>Revendas de veículos usados;</li>
        ...
        <h2>Trabalhista</h2>
        <ul>
          <li>Processo admissional de empregado: cadastro no PIS, registro em CTPS, preenchimento do Livro de Registro de Empregados e elaboração de contratos de experiência e de estagiários;</li>
          <li>Manutenção de Registro de Empregados (atualização de CTPS, livro de registro de empregados);</li>
          <li>Elaboração da Folha de Pagamentos de Salários e Pró-Labore com a emissão de contra cheque em sistema informatizado e integrado;</li>
          <li>Acompanhamento de Acordos e Dissídios Coletivos;</li>
        ...
        <h2>Pessoa Física</h2>
        <ul>
          <li>Escrituração do Livro Caixa e cálculo do carnê leão para profissionais da área de saúde;</li>
          <li>Elaboração da declaração de imposto de renda da pessoa física, de forma individualizada com soluções inteligentes;</li>
          <li>Acompanhamento do processamento da declaração de imposto de renda e solução de pendências.</li>
        </ul>
      </div>
    </section>
  </div>
